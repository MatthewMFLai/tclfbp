...
source $env(WEB_DRIVER)/browse/browse_fsm.tcl
...
proc fsm_if {tag slash param text} {
    ...
    set rc [Fsm::Run browse_fsm tmpdata]
    if {$rc < 0} {
	puts "rc = $rc"
	puts [Fsm::Get_Error browse_fsm]
	exit -1
    }
}
