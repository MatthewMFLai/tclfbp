...
source $env(WEB_DRIVER)/translate2/translate2_fsm.tcl
...
proc fsm_if {tag slash param text} {
    ...
    set rc [Fsm::Run translate2_fsm tmpdata]
    if {$rc < 0} {
	puts "rc = $rc"
	puts [Fsm::Get_Error translate2_fsm]
	exit -1
    }
}
...
if {$sanity_mode} {
    ...
    Fsm::Load_Fsm translate2_fsm.dat
...
if {$sanity_mode} {
    ...
    # Retrieve data from translate2_fsm...
    # ...
    # ...
    if {$sanity != "test"} {
