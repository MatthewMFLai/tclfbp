...
# 55 "test_helper.c"
                       )
    {
        ...
        free(p_cur_next);
        return (
# 68 "test_helper.c" 3 4
               1
# 68 "test_helper.c"
                   );
    }
    return (
# 70 "test_helper.c" 3 4
           0
# 70 "test_helper.c"
                );
}
...
char *port_mgr_msg_get(char *p_port, int offset)
{
    char *p_buffer = port_mgr_get_buffer(p_port);
    if (p_buffer == 
# 149 "test_helper.c" 3 4
                   ((void *)0)
# 149 "test_helper.c"
                       )
        return (
# 150 "test_helper.c" 3 4
               ((void *)0)
# 150 "test_helper.c"
                   );
