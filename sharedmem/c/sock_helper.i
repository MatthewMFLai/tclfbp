...
# 60 "sock_helper.c"
                       )
    {
        ...
        free(p_cur_next);
        return (
# 76 "sock_helper.c" 3 4
               1
# 76 "sock_helper.c"
                   );
    }
    return (
# 78 "sock_helper.c" 3 4
           0
# 78 "sock_helper.c"
                );
}
...
char *key_mgr_bcd_get(char *p_key)
{
    ...
    if (p_cur == 
# 151 "sock_helper.c" 3 4
                ((void *)0)
# 151 "sock_helper.c"
                    )
        return (
# 152 "sock_helper.c" 3 4
               ((void *)0)
# 152 "sock_helper.c"
                   );
